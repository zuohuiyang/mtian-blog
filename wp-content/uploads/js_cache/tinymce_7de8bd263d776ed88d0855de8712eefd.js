var tinyMCEPreInit = { settings : { themes : "advanced", plugins : "safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage", languages : "zh", debug : false }, base : "http://blog.mtian.cn/wp-includes/js/tinymce", suffix : "", query : "ver=311" };tinyMCEPreInit.start = function() {
...
class_name:"类",
not_set:"--未设置--",
clipboard_msg:"复制/剪切/粘贴 在 Mozilla 和 Firefox 中不可用。",
clipboard_no_support:"目前不受您的浏览器支持，请使用链接快捷键代替。",
popup_blocked:"抱歉，您的弹出窗口拦截器阻止了一个提供了程序功能的窗口。您需要在本站点上禁用弹出窗口拦截器以使该工具运行正常。",
invalid_data:"错误：输入的值无效，已经用红色标出。",
more_colors:"更多颜色"
},
contextmenu:{
align:"对齐方式",
...
months_long:"01月,02月,03月,04月,05月,06月,07月,08月,09月,10月,11月,12月",
months_short:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec",
day_long:"星期日,星期一,星期二,星期三,星期四,星期五,星期六",
...
nonbreaking:{
nonbreaking_desc:"插入连续空格字符"
},
iespell:{
iespell_desc:"运行拼写检查",
download:"没有检测到 ieSpell。是否立刻安装？"
},
advhr:{
advhr_desc:"水平标尺"
},
...
paste_dlg:{
text_title:"使用 Ctrl+V 以将文本粘贴到窗口中。",
text_linebreaks:"保留断行标记",
word_title:"使用 Ctrl+V 以将文本粘贴到窗口中。"
},
table:{
desc:"插入新表格",
row_before_desc:"在前面插入行",
row_after_desc:"在后面插入行",
delete_row_desc:"删除行",
col_before_desc:"在前面插入列",
col_after_desc:"在后面插入列",
delete_col_desc:"移除列",
...
cell_desc:"格属性",
props_desc:"表格属性",
paste_row_before_desc:"在前面粘贴表格行",
paste_row_after_desc:"在后面粘贴表格行",
cut_row_desc:"剪切该行",
copy_row_desc:"复制该行",
del:"删除表格",
row:"行",
...
autosave:{
unload_msg:"离开本页，将丢失您在本页所作的修改。"
},
fullscreen:{
desc:"切换全屏模式 (Alt+Shift+G)"
},
media:{
desc:"插入/编辑内嵌多媒体",
delta_width:"0",
...
justifyfull_desc:"完全对齐 (Alt+Shift+J)",
bullist_desc:"无序列表 (Alt+Shift+U)",
numlist_desc:"有序列表 (Alt+Shift+O)",
outdent_desc:"减少缩进量",
indent_desc:"增加缩进量",
undo_desc:"撤消 (Ctrl+Z)",
redo_desc:"重做 (Ctrl+Y)",
...
link_delta_width:"0",
link_delta_height:"0",
unlink_desc:"删除链接 (Alt+Shift+S)",
image_desc:"插入/编辑图片 (Alt+Shift+M)",
image_delta_width:"0",
...
help_desc:"帮助",
blockquote_desc:"块引用 (Alt+Shift+Q)",
clipboard_msg:"复制/剪切/粘贴 在 Mozilla 和 Firefox 中不可用。",
path:"路径",
newdocument:"确实要清除所有内容？",
toolbar_focus:"Alt+Q 切换到工具按钮，Alt-Z 切换到编辑器，Alt-X 切换到元素路径",
more_colors:"更多颜色",
...
link_url:"链接 URL",
link_target:"打开方式",
link_target_same:"在原窗口中打开链接",
link_target_blank:"在新窗口中打开链接",
link_titlefield:"标题",
link_is_email:"您输入的链接似乎是一个电子邮箱地址，您想为其添加 “ Mailto: ” 前缀吗？",
link_is_external:"您输入的链接似乎是一个外部链接，您想为其添加 “ http:// ” 前缀吗？",
link_list:"链接列表"
});
...
autogotourl:"自动跳转到 URL",
center:"中",
imagestatus:"图片状态",
maintainaspect:"保持高宽比",
nojava:"无 Java",
prefetch:"预读",
shuffle:"乱序",
console:"控制台",
...
swstretchstyle:"拉伸方式",
swstretchhalign:"水平拉伸",
swstretchvalign:"垂直拉伸",
sound:"声音",
progress:"进度",
qtsrc:"QT 源",
qt_stream_warn:"RTSP 流媒体资源需要添加在高级标签下的“QT 源”字段中。",
align_top:"上",
align_right:"右",
align_bottom:"下",
align_left:"左",
...
wp_adv_desc:"显示/隐藏高级工具栏 (Alt+Shift+Z)",
wp_more_desc:"插入“更多”标签 (Alt+Shift+T)",
wp_page_desc:"插入页面截断 (Alt+Shift+P)",
...
current_link:"当前链接",
link_to_img:"链接到图像",
link_help:"输入链接 URL 或点击上面的按钮以使用预置方案",
adv_img_settings:"高级图像设置",
source:"源代码",
width:"宽度",
height:"高度",
orig_size:"原始尺寸",
css:"样式表类",
adv_link_settings:"高级链接设置",
link_rel:"链接 Rel",
height:"高度",
orig_size:"原始尺寸",
css:"样式表类",
...
tinyMCE.init({mode:"none",onpageload:"wpEditorInit",width:"100%",theme:"advanced",skin:"wp_theme",theme_advanced_buttons1:"bold,italic,strikethrough,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,link,unlink,wp_more,|,spellchecker,fullscreen,wp_adv",theme_advanced_buttons2:"formatselect,underline,justifyfull,forecolor,|,pastetext,pasteword,removeformat,|,media,charmap,|,outdent,indent,|,undo,redo,wp_help",theme_advanced_buttons3:"",theme_advanced_buttons4:"",language:"zh",spellchecker_languages:"+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:"1",theme_advanced_resize_horizontal:"",dialog_type:"modal",relative_urls:"",remove_script_host:"",convert_urls:"",apply_source_formatting:"",remove_linebreaks:"1",paste_convert_middot_lists:"1",paste_remove_spans:"1",paste_remove_styles:"1",gecko_spellcheck:"1",entities:"38,amp,60,lt,62,gt",accessibility_focus:"",tab_focus:":next",content_css:"http://blog.mtian.cn/wp-includes/js/tinymce/wordpress.css",save_callback:"switchEditors.saveCallback",wpeditimage_disable_captions:"",plugins:"safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage"});